...
const ComprehensiveTestingOffer: React.FC = () => {
  ...
  return (
    <div className="space-y-4 mt-4">
      {/* Headline Section */}
      <div className="text-center bg-gradient-to-br from-red-50 to-orange-50 p-4 rounded-lg border-l-2 border-red-400">
        <h2 className="font-headline text-xl lg:text-2xl font-bold text-red-700 mb-2">
      ...
      <Card className="border-l-2 border-red-500">
        <CardContent className="p-4">
          <h3 className="font-headline text-lg font-bold text-gray-800 mb-3 flex items-center">
      ...
      <Card className="border-l-2 border-orange-500">
        <CardContent className="p-4">
          <h3 className="font-headline text-lg font-bold text-gray-800 mb-3">
            What Happens When Hormone Imbalances Go Untested:
          </h3>
          
          <div className="grid md:grid-cols-2 gap-3">
            <div className="bg-red-50 p-3 rounded-lg">
              <h4 className="font-semibold text-red-700 mb-2 text-sm">🔴 Cardiovascular Risk:</h4>
              <p className="text-gray-700 text-sm">
            ...
            <div className="bg-red-50 p-3 rounded-lg">
              <h4 className="font-semibold text-red-700 mb-2 text-sm">🔴 Bone Density Loss:</h4>
              <p className="text-gray-700 text-sm">
            ...
            <div className="bg-red-50 p-3 rounded-lg">
              <h4 className="font-semibold text-red-700 mb-2 text-sm">🔴 Cognitive Decline:</h4>
              <p className="text-gray-700 text-sm">
            ...
            <div className="bg-red-50 p-3 rounded-lg">
              <h4 className="font-semibold text-red-700 mb-2 text-sm">🔴 Mental Health Crisis:</h4>
              <p className="text-gray-700 text-sm">
      ...
      <Card className="border-l-2 border-green-500 bg-gradient-to-br from-green-50 to-blue-50">
        <CardContent className="p-4">
          <div className="text-center mb-3">
            <h3 className="font-headline text-xl font-bold text-green-700 mb-2">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            <div>
              ...
              <ul className="space-y-2 text-gray-700 text-sm">
                <li className="flex items-center"><CheckCircle className="text-green-500 mr-2" size={12} />Estradiol (E2) - Multiple measurements</li>
                <li className="flex items-center"><CheckCircle className="text-green-500 mr-2" size={12} />Progesterone - Cycle-specific timing</li>
                <li className="flex items-center"><CheckCircle className="text-green-500 mr-2" size={12} />Testosterone (Free & Total)</li>
                <li className="flex items-center"><CheckCircle className="text-green-500 mr-2" size={12} />DHEA-S - Adrenal function</li>
                <li className="flex items-center"><CheckCircle className="text-green-500 mr-2" size={12} />Cortisol (4-point) - Stress response</li>
                <li className="flex items-center"><CheckCircle className="text-green-500 mr-2" size={12} />Thyroid Panel (TSH, T3, T4, rT3)</li>
                <li className="flex items-center"><CheckCircle className="text-green-500 mr-2" size={12} />Insulin & Glucose - Metabolic health</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700 mb-3 text-sm">
                <li className="flex items-center"><CheckCircle className="text-green-500 mr-2" size={12} />Hormone ratios and patterns</li>
                <li className="flex items-center"><CheckCircle className="text-green-500 mr-2" size={12} />Age-specific optimal ranges</li>
                <li className="flex items-center"><CheckCircle className="text-green-500 mr-2" size={12} />Symptom correlation mapping</li>
                <li className="flex items-center"><CheckCircle className="text-green-500 mr-2" size={12} />Personalized recommendations</li>
              </ul>

              <h4 className="font-semibold text-gray-800 text-base mb-2">Professional Interpretation:</h4>
              <ul className="space-y-2 text-gray-700 text-sm">
                <li className="flex items-center"><CheckCircle className="text-green-500 mr-2" size={12} />Detailed results explanation</li>
                <li className="flex items-center"><CheckCircle className="text-green-500 mr-2" size={12} />Specific treatment suggestions</li>
                <li className="flex items-center"><CheckCircle className="text-green-500 mr-2" size={12} />Lifestyle optimization plan</li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-4 text-center">
            <Button 
              ...
              className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-bold py-3 px-8 rounded-lg text-base transform hover:scale-105 transition-all duration-200"
            >
              Order Bloodwork
            </Button>
          </div>
      ...
      <Card className="border-l-2 border-purple-500 bg-purple-50">
        <CardContent className="p-4">
          <h3 className="font-headline text-lg font-bold text-purple-800 mb-3 flex items-center">
          ...
          <div className="grid md:grid-cols-3 gap-3 mb-3">
            <div className="text-center">
              <div className="bg-white p-3 rounded-lg shadow-sm">
                <h4 className="font-semibold text-purple-700 mb-2 text-sm">Time Remaining</h4>
            ...
            <div className="text-center">
              <div className="bg-white p-3 rounded-lg shadow-sm">
                <h4 className="font-semibold text-purple-700 mb-2 text-sm">Spots Remaining</h4>
                <div className="text-base font-bold text-red-600">{spotsRemaining}</div>
              </div>
            </div>
            
            <div className="text-center">
              <div className="bg-white p-3 rounded-lg shadow-sm">
                <h4 className="font-semibold text-purple-700 mb-2 text-sm">Success Rate</h4>
                <div className="text-base font-bold text-green-600">96%</div>
              </div>
            </div>
          </div>
        ...
        <CardContent className="p-4">
          ...
          <div className="grid md:grid-cols-3 gap-3">
            <div className="bg-blue-50 p-3 rounded-lg">
              ...
              <p className="font-semibold text-blue-700 text-sm">- Sarah, 44</p>
            </div>
            ...
            <div className="bg-blue-50 p-3 rounded-lg">
              ...
              <p className="font-semibold text-blue-700 text-sm">- Jennifer, 47</p>
            </div>
            ...
            <div className="bg-blue-50 p-3 rounded-lg">
              ...
              <p className="font-semibold text-blue-700 text-sm">- Michelle, 45</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-l-2 border-green-500 bg-green-50">
        <CardContent className="p-4">
          <h3 className="font-headline text-lg font-bold text-green-800 mb-3 flex items-center">
      ...
      <Card className="border-l-2 border-red-500 bg-gradient-to-br from-red-50 to-orange-50">
        <CardContent className="p-4 text-center">
          <h3 className="font-headline text-xl font-bold text-red-700 mb-3">
          ...
          <p className="text-base font-semibold text-purple-700 mb-3">
      ...
      <Card className="border-l-2 border-purple-500 bg-gradient-to-br from-purple-50 to-pink-50">
        <CardContent className="p-4 text-center">
          <h3 className="font-headline text-xl font-bold text-purple-800 mb-2">
            Order Your Comprehensive Hormone Assessment
          </h3>
          
          <div className="text-3xl font-bold text-green-600 mb-2">$199</div>
          <p className="text-base text-gray-600 mb-3">Complete Perimenopause Testing Panel</p>
          ...
          <div className="grid md:grid-cols-2 gap-2 text-left max-w-2xl mx-auto mb-3">
            <div>
              <p className="flex items-center text-gray-700 text-sm"><CheckCircle className="text-green-500 mr-2" size={12} />12 Critical Hormones Tested</p>
              <p className="flex items-center text-gray-700 text-sm"><CheckCircle className="text-green-500 mr-2" size={12} />Professional Interpretation Included</p>
              <p className="flex items-center text-gray-700 text-sm"><CheckCircle className="text-green-500 mr-2" size={12} />Personalized Treatment Recommendations</p>
            </div>
            <div>
              <p className="flex items-center text-gray-700 text-sm"><CheckCircle className="text-green-500 mr-2" size={12} />Same-Day Lab Appointments Available</p>
              <p className="flex items-center text-gray-700 text-sm"><CheckCircle className="text-green-500 mr-2" size={12} />Results in 3-5 Business Days</p>
              <p className="flex items-center text-gray-700 text-sm"><CheckCircle className="text-green-500 mr-2" size={12} />30-Day Money-Back Guarantee</p>
            </div>
          </div>
