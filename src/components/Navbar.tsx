...
const Navbar = () => {
  ...
  const handleSectionNavigation = (sectionId: string) => {
    ...
    // If we're not on the try page, navigate there first
    if (window.location.pathname !== '/try') {
      window.location.href = `/try#${sectionId}`;
      return;
    }
      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link to="/try" className="text-primary font-medium hover:text-primary/80 transition-colors">
              Home
            </Link>
            <button
