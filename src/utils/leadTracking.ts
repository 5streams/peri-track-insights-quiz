...
export interface Lead {
  ...
  pricing_tier?: 'monthly' | 'annual' | 'free_trial' | 'WGFreeTrial' | 'InsomniaFreeTrial' | 'BW' | null;
  quiz_results?: any;
  created_at?: string;
...
export const saveLead = async (
  ...
  email: string,
  source: 'quiz_results' | 'free_trial' | string,
  pricingTier?: 'monthly' | 'annual' | 'free_trial' | 'WGFreeTrial' | 'InsomniaFreeTrial' | 'BW' | null,
  quizResults?: any,
  notes?: string,
  address?: string
): Promise<Lead> => {
