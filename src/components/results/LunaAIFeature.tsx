...
const LunaAIFeature: React.FC<LunaAIFeatureProps> = ({ onStartTrial }) => {
  ...
  return (
    <Card className="mb-6 md:mb-8 overflow-hidden reveal-section transform opacity-0 border-t-4 border-[#9b87f5] bg-gradient-to-br from-[#F9F5FF]/60 to-white hover:shadow-xl transition-all duration-300">
      <CardContent className="p-5 md:p-8">
        ...
        <div className="max-w-5xl mx-auto">
          {/* Main Description */}
          <p className="text-center text-[#5D4154] mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-white p-5 rounded-lg border border-[#9b87f5]/20 shadow-sm hover:shadow-md transition-all">
            ...
            <div className="bg-white p-5 rounded-lg border border-[#9b87f5]/20 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center mb-3">
                <div className="bg-[#9b87f5]/20 p-2 rounded-full mr-3">
                  <CircleUser className="h-5 w-5 text-[#9b87f5]" />
                </div>
                <h3 className="font-bold text-[#5D4154]">
          ...
          <div className="mb-8">
            <h3 className="text-lg font-bold text-center text-[#5D4154] mb-4">
              SEE HOW LUNA HELPS WOMEN LIKE YOU
            </h3>
            
            <div className="grid md:grid-cols-3 gap-4">
              {/* Example 1: Information */}
              <div className="bg-[#F9F5FF]/40 p-4 rounded-lg">
                <div className="flex mb-3">
                  <div className="flex-shrink-0 h-8 w-8 rounded-full bg-[#9b87f5]/30 flex items-center justify-center mr-2">
                    <span className="text-[#7E69AB] font-bold">😴</span>
                  </div>
                  <div className="bg-white rounded-lg p-2 shadow-sm text-sm flex-1">
                    <p className="font-medium">Why am I having trouble sleeping even though I'm exhausted?</p>
                  </div>
                </div>
                <div className="flex">
                  ...
                  <div className="bg-[#9b87f5]/10 rounded-lg p-2 shadow-sm text-sm flex-1">
                    <p>Sleep disruption is common during perimenopause. Many women experience this due to changing hormone levels. Would you like to learn about some approaches others have found helpful?</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#F9F5FF]/40 p-4 rounded-lg">
                <div className="flex mb-3">
                  ...
                  <div className="bg-white rounded-lg p-2 shadow-sm text-sm flex-1">
                    <p className="font-medium">I'm feeling so frustrated today. No one seems to understand what I'm going through.</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0 h-8 w-8 rounded-full bg-[#9b87f5] flex items-center justify-center mr-2">
                  ...
                  <div className="bg-[#9b87f5]/10 rounded-lg p-2 shadow-sm text-sm flex-1">
                    <p>That sounds really challenging. Many women feel isolated during perimenopause because these experiences aren't discussed openly. Your feelings are completely valid. Would it help to talk more about what's been most difficult?</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#F9F5FF]/40 p-4 rounded-lg">
                <div className="flex mb-3">
                  ...
                  <div className="bg-white rounded-lg p-2 shadow-sm text-sm flex-1">
                    <p className="font-medium">I have a doctor's appointment next week. What should I ask about?</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0 h-8 w-8 rounded-full bg-[#9b87f5] flex items-center justify-center mr-2">
                  ...
                  <div className="bg-[#9b87f5]/10 rounded-lg p-2 shadow-sm text-sm flex-1">
                    <p>Great that you're preparing! Based on the symptoms you've tracked, you might want to discuss your sleep disruptions and mood changes. Here are some specific questions that could help you get the information you need...</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Testimonials */}
          <div className="mb-8 bg-[#F9F5FF]/30 p-5 rounded-lg">
            <h3 className="text-lg font-bold text-center text-[#5D4154] mb-4">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <div className="flex items-center mb-2">
                  <div className="flex-shrink-0">
                    <div className="h-8 w-8 rounded-full bg-[#9b87f5]/20 flex items-center justify-center">
                      <span className="font-semibold text-[#7E69AB]">R</span>
                    </div>
                  </div>
                  <div className="ml-3">
                    <p className="font-medium text-[#5D4154]">Rebecca, 46</p>
                  </div>
                </div>
                <p className="text-sm text-[#5D4154]/80 italic">
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <div className="flex items-center mb-2">
                  ...
                  <div className="ml-3">
                    <p className="font-medium text-[#5D4154]">Michelle, 43</p>
                  </div>
                </div>
                <p className="text-sm text-[#5D4154]/80 italic">
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <div className="flex items-center mb-2">
                  ...
                  <div className="ml-3">
                    <p className="font-medium text-[#5D4154]">Patricia, 48</p>
                  </div>
                </div>
                <p className="text-sm text-[#5D4154]/80 italic">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="text-center p-4">
                ...
                <h4 className="font-bold text-[#5D4154] mb-1">TRACK</h4>
                <p className="text-sm text-[#5D4154]/80">Log your experiences in our easy-to-use interface</p>
              </div>
              
              <div className="text-center p-4">
                <div className="h-12 w-12 bg-[#9b87f5] rounded-full flex items-center justify-center text-white font-bold mx-auto mb-2">2</div>
                <h4 className="font-bold text-[#5D4154] mb-1">LEARN</h4>
                <p className="text-sm text-[#5D4154]/80">Review your patterns and explore educational content with Luna's guidance</p>
              </div>
              
              <div className="text-center p-4">
                <div className="h-12 w-12 bg-[#9b87f5] rounded-full flex items-center justify-center text-white font-bold mx-auto mb-2">3</div>
                <h4 className="font-bold text-[#5D4154] mb-1">CONNECT</h4>
                <p className="text-sm text-[#5D4154]/80">Chat with Luna anytime you have questions or need support</p>
              </div>
            </div>
          </div>
          
          {/* Why Luna Makes the Difference */}
          <div className="bg-[#9b87f5]/10 p-5 rounded-lg mb-8">
            <h3 className="text-lg font-bold text-center text-[#5D4154] mb-4">
              WHY LUNA MAKES THE DIFFERENCE
            </h3>
            
            <p className="text-[#5D4154]/80 text-center mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-[#5D4154]">24/7 access for unlimited conversations</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-[#5D4154]">Personalized insights based on your data</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-[#5D4154]">Guidance for healthcare appointments</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-[#5D4154]">Emotional support whenever you need it</p>
              </div>
            </div>
          </div>
          ...
          {/* Final CTA */}
          <div className="text-center">
            <h3 className="text-lg md:text-xl font-bold text-[#5D4154] mb-4">
            ...
            <p className="text-sm text-[#5D4154]/70">
