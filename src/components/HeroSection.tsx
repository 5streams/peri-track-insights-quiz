...
const HeroSection = () => {
  ...
  return (
    <section className="hero-section bg-hero-gradient py-3 lg:py-4 min-h-[50vh] flex items-center">
      <div className="container mx-auto px-3">
        <div className="grid lg:grid-cols-2 gap-4 items-center">
          <div className="hero-content fade-in-up">
            <h1 className="font-headline font-bold text-h1 text-primary mb-2 leading-tight">
              Track Your Perimenopause Journey with Confidence
            </h1>
            
            <p className="text-body-large text-warm-gray font-medium mb-2 leading-relaxed">
            ...
            <p className="text-body-regular text-warm-gray mb-3 leading-relaxed">
            ...
            <div className="social-proof-mini bg-white p-2 rounded-xl mb-3 shadow-lg border border-gray-100">
          ...
          <div className="hero-visual fade-in-up text-center">
            <div className="relative inline-block animate-float">
              <img 
                ...
                className="w-auto h-auto max-w-full max-h-[500px] rounded-[2rem] shadow-2xl mx-auto"
              />
            </div>
          </div>
        </div>
