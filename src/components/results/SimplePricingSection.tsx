...
const SimplePricingSection: React.FC<SimplePricingSectionProps> = ({ onStartTrial }) => {
  ...
  return (
    <Card className="mb-6 p-0 overflow-hidden border-none shadow-lg reveal-section transform opacity-0">
      <div className="max-w-4xl mx-auto p-3">
        <h2 className="text-2xl font-bold text-center text-[#5D4154] mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
            <div className="p-3">
              <h3 className="text-xl font-bold text-[#5D4154] mb-2">Monthly Plan</h3>
              ...
              <Button 
                ...
                className="w-full h-10 bg-[#9b87f5] hover:bg-[#9b87f5]/90 text-white uppercase"
              >
                Start My Free Trial
              </Button>
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden border-2 border-[#9b87f5] relative">
            <div className="absolute top-0 right-0 bg-[#9b87f5] text-white px-3 py-0.5 text-xs font-bold">
              BEST VALUE
            </div>
            
            <div className="p-3">
              <h3 className="text-xl font-bold text-[#5D4154] mb-2">Annual Plan</h3>
