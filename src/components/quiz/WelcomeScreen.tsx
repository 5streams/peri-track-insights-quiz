...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onStart }) => {
  return (
    <div className="text-center flex flex-col items-center max-w-3xl mx-auto py-4">
      <h1 className="font-playfair text-3xl md:text-4xl font-bold text-slate-800 mb-3">
        Perimenopause Symptoms Quiz: Discover What's Really Happening to Your Body
      </h1>
      
      <p className="text-lg md:text-xl mb-3 text-slate-600">
      ...
      <Button 
        onClick={onStart} 
        size="lg" 
        className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-5 text-lg transition-colors mb-5"
      >
      ...
      <div className="flex items-center justify-center gap-3 flex-wrap">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-sm text-slate-600">30,000+ women assessed</span>
        </div>
        <div className="flex items-center gap-1.5">
          <Check className="h-4 w-4 text-purple-600" />
